...
import { UserPlus, Mail, Lock, ArrowRight, Sparkles, User } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white relative overflow-hidden flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md relative z-10 animate-fadeIn">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-3 text-gray-400 font-medium">Create your account and start evolving</p>
        </div>
        ...
        <div className="relative bg-gradient-to-br from-[#1e293b] to-[#0f172a] border border-cyan-500/30 rounded-3xl p-8 shadow-2xl shadow-cyan-500/10">
          ...
          <div className="relative">
            ...
            <p className="text-gray-400 mb-8">Join thousands of productive users today</p>
            ...
            <form onSubmit={handleSignup} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-cyan-400" />
                  <input
                    type="text"
                    value={name}
