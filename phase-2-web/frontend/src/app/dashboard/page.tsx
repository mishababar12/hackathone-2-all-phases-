...
import { Plus, LogOut, Loader2, Sparkles, CheckCircle, Home, ListTodo, CheckCheck, AlertCircle, BarChart3, Flag } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white relative overflow-hidden flex">
      ...
      {/* Sidebar */}
      <aside className="relative w-80 bg-white/5 backdrop-blur-xl border-r border-cyan-500/20 flex-shrink-0 overflow-y-auto">
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Priority Breakdown</h3>
            <div className="space-y-2">
              <div className="flex items-center justify-between p-3 rounded-lg bg-red-500/20 border border-red-400/30">
                <div className="flex items-center gap-2">
                  <Flag className="h-4 w-4 text-red-400" />
                  <span className="text-sm font-medium text-red-300">High</span>
                </div>
                <span className="text-lg font-bold text-red-300">{highPriorityTasks}</span>
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg bg-yellow-500/20 border border-yellow-400/30">
                <div className="flex items-center gap-2">
                  <Flag className="h-4 w-4 text-yellow-400" />
                  <span className="text-sm font-medium text-yellow-300">Medium</span>
                </div>
                <span className="text-lg font-bold text-yellow-300">{mediumPriorityTasks}</span>
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg bg-green-500/20 border border-green-400/30">
                <div className="flex items-center gap-2">
                  <Flag className="h-4 w-4 text-green-400" />
                  <span className="text-sm font-medium text-green-300">Low</span>
                </div>
                <span className="text-lg font-bold text-green-300">{lowPriorityTasks}</span>
              </div>
            </div>
          </div>
        ...
        <nav className="relative backdrop-blur-xl bg-white/5 border-b border-cyan-500/20 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="px-4 py-2 rounded-xl bg-cyan-500/20 border border-cyan-400/30">
              <span className="text-sm font-bold text-cyan-300">{progressPercent}% Complete</span>
            </div>
          </div>
        </nav>
