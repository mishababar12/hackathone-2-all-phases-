      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="relative flex-1 overflow-y-auto px-6 py-8">
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            {/* AI Chat Assistant Modal - Right Side */}
        {isChatOpen && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-end p-4 animate-fadeIn">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-cyan-400/30 rounded-2xl shadow-2xl shadow-cyan-500/30 w-full max-w-md max-h-[90vh] flex flex-col transform transition-transform duration-300 translate-x-0">
        ...
        <div className="fixed bottom-8 right-8 flex items-end gap-3 z-40">
          <button
            onClick={() => setIsModalOpen(true)}
            className="w-16 h-16 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 shadow-2xl shadow-cyan-500/50 flex items-center justify-center text-white hover:scale-110 hover:shadow-cyan-500/70 transition-all duration-300 hover:rotate-90 z-40"
          >
          ...
          {!isChatOpen && (
            <button
              ...
              className="w-16 h-16 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 shadow-2xl shadow-cyan-500/50 flex items-center justify-center text-white hover:scale-110 hover:shadow-cyan-500/70 transition-all duration-300 z-40 animate-pulse"
            >
